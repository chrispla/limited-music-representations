...
if __name__ == "__main__":
    ...
    train_dataset = get_dataset(
        args.dataset, args.dataset_dir, subset="train", args=args
    )
    valid_dataset = get_dataset(
        args.dataset, args.dataset_dir, subset="valid", args=args
    )
    ...
    logger = WandbLogger(name="CLMRv2-{}".format(args.dataset), project="clmr")
    ...
    if args.supervised:
        test_dataset = get_dataset(
            args.dataset, args.dataset_dir, subset="test", args=args
        )
